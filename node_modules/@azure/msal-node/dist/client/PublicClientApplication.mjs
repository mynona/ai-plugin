...
import { ServerTelemetryManager, enforceResourceParameter, AuthError, Constants as Constants$1, createClientConfigurationError, ClientConfigurationErrorCodes, ServerError, AADServerParamKeys } from '@azure/msal-common/node';
...
class PublicClientApplication extends ClientApplication {
    ...
    async acquireTokenInteractive(request) {
        ...
        const responseMode = remainingProperties.responseMode ??
            Constants$1.ResponseMode.QUERY;
        if (responseMode !== Constants$1.ResponseMode.QUERY &&
            responseMode !== Constants$1.ResponseMode.FORM_POST) {
            throw createClientConfigurationError(ClientConfigurationErrorCodes.invalidResponseMode, correlationId);
        }
