...
class OnBehalfOfClient extends BaseClient {
    ...
    async getCachedAuthenticationResult(request) {
        ...
        if (cachedIdToken) {
            idTokenClaims = AuthToken.extractTokenClaims(cachedIdToken.secret, EncodingUtils.base64Decode, request.correlationId);
    ...
    readAccessTokenFromCacheForOBO(clientId, request) {
        ...
        if (numAccessTokens < 1) {
            ...
            throw createClientAuthError(ClientAuthErrorCodes.multipleMatchingTokens, request.correlationId);
        }
