...
'use strict';
import { Constants, TokenCacheContext, ScopeSet, TimeUtils, ResponseHandler, createClientAuthError, ClientAuthErrorCodes, UrlString, RequestParameterBuilder, getClientAssertion, AADServerParamKeys, StringUtils, UrlUtils } from '@azure/msal-common/node';
...
class ClientCredentialClient extends BaseClient {
    ...
    readAccessTokenFromCache(authority, id, scopeSet, cacheManager, correlationId, additionalCacheKeyComponents) {
        ...
        if (accessTokens.length < 1) {
            ...
            throw createClientAuthError(ClientAuthErrorCodes.multipleMatchingTokens, correlationId);
        }
    ...
    async createTokenRequestBody(request) {
        ...
        if (clientAssertion) {
            RequestParameterBuilder.addClientAssertion(parameters, await getClientAssertion(clientAssertion.assertion, this.config.authOptions.clientId, this.authority.tokenEndpoint, request.fmiPath));
        ...
        if (!StringUtils.isEmptyObj(request.claims) ||
            ...
            RequestParameterBuilder.addClaims(parameters, request.correlationId, request.claims, this.config.authOptions.clientCapabilities);
        }
